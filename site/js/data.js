...
/* Реквизиты юридического лица. Пустые поля нигде не показываются —
   заполняйте по мере готовности (юр. адрес, банк и т.д.). */
window.INAVTO.COMPANY = {
  full: 'Общество с ограниченной ответственностью «ИНАВТО АЗИЯ»',
  short: 'ООО «ИНАВТО АЗИЯ»',
  inn: '2366058817',
  kpp: '236601001',
  ogrn: '1262300026163',
  address: '',      // юридический адрес
  director: '',     // ФИО руководителя (для договоров)
...
window.INAVTO.CARS = [
  ...
  },
  {
    ...
    /* Образец подробной карточки. Значения заполняются в админке —
       страница показывает только непустые поля. */
    specs: {
      basic: {
        brand: 'Zeekr', model: '7X', trim: 'Long Range RWD (одномоторная)', year: '2025',
        country: 'Китай', body: 'Кроссовер (SUV)', seats: '5',
        colorBody: 'на выбор: белый, чёрный, серый, синий',
        colorInterior: 'на выбор: светлый, тёмный',
        mileage: 'новый автомобиль',
      },
      engine: {
        type: 'Электромотор на задней оси', power: '421 л.с. (310 кВт)', torque: '440 Н·м',
        eco: 'Электромобиль, нулевые выбросы', fuel: 'Электричество',
        consumption: '≈ 16,5 кВт·ч / 100 км',
        tank: 'Батарея 100 кВт·ч, запас хода 705 км',
      },
      trans: {
        gearbox: 'Односкоростной редуктор', drive: 'Задний',
        accel: '6,0 с', maxSpeed: '200 км/ч',
      },
      dims: {
        length: '4787 мм', width: '1930 мм', height: '1650 мм', wheelbase: '2925 мм',
        clearance: '168 мм', weight: '2265 кг', tires: '235/50 R20',
        trunk: '539 л + 62 л под капотом',
      },
      options: [
        'Светодиодная оптика', 'Дневные ходовые огни', 'Панорамная крыша / люк',
        'Электропривод передних сидений', 'Подогрев передних сидений', 'Вентиляция сидений',
        'Память сидений', 'Многофункциональный руль', 'Цифровая приборная панель',
        'Мультимедийная система', 'Беспроводная зарядка смартфона', 'Климат-контроль',
        'Камера 360°', 'Передние и задние парктроники', 'Адаптивный круиз-контроль',
        'Система удержания в полосе', 'Контроль слепых зон',
        'Система автоматического экстренного торможения', 'Электропривод багажника',
        'Бесключевой доступ', 'Кнопка запуска двигателя', 'Атмосферная подсветка салона',
      ],
      text: 'Zeekr 7X — среднеразмерный электрический кроссовер на 800-вольтовой платформе. '
        + 'Зарядка с 10 до 80% занимает около 16 минут на быстрой станции, запас хода — 705 км по циклу CLTC.\n\n'
        + 'В базовое оснащение уже входит то, что у европейских конкурентов идёт за доплату: панорамная крыша, '
        + 'вентиляция и память передних сидений, камеры кругового обзора, адаптивный круиз-контроль и полный набор '
        + 'систем помощи водителю.\n\n'
        + 'Цена «под ключ» указана с логистикой, таможенной пошлиной, утильсбором, СБКТС/ЭПТС и нашей комиссией — '
        + 'фиксируется в договоре до начала работы.',
    },
  },
  {
